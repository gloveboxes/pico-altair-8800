...
#define LWIP_ALTCP 1                // Enable layered TCP for TLS clients
#define LWIP_ALTCP_TLS 1            // Enable TLS over ALTCP
#define LWIP_ALTCP_TLS_MBEDTLS 1    // Use mbedTLS backend for ALTCP TLS
